    ...
    <section id="projects">
      ...
      <div className="projects-container">
        <div className="project-card">
          ...
          <a href="https://projectweatherappweb.netlify.app" target='_blank' rel="noopener noreferrer">click here</a>
        ...
        <div className="project-card">
          ...
          <a href="https://crypto-tarcker-web-app.netlify.app" target='_blank' rel="noopener noreferrer">click here</a>
